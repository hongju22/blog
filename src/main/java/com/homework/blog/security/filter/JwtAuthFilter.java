package com.homework.blog.security.filter;

import com.homework.blog.security.FilterSkipMatcher;
import com.homework.blog.security.jwt.HeaderTokenExtractor;
import com.homework.blog.security.jwt.JwtPreProcessingToken;
...
public class JwtAuthFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public JwtAuthFilter(FilterSkipMatcher matcher, HeaderTokenExtractor headerTokenExtractor, HeaderTokenExtractor extractor) {
        super((RequestMatcher) matcher, (AuthenticationManager) headerTokenExtractor);
        this.extractor = extractor;
    }
